...
const styles = StyleSheet.create({
  ...
  checkedHihat: {
    width: '100%',
    aspectRatio: 1 / 1,
    borderRadius: (deviceWidth * 0.07) / 2,
    borderWidth: 2,
  ...
  presetWrapper: {
    ...
    flexShrink: 1,
    marginTop: Platform.OS !== 'ios' && isTablet ? '-2.5%' : '-4.5%',
  },
  presetBtn: {
    borderWidth: 2,
    borderRadius: 24,
  ...
  sliderWrapper: {
    ...
    flexGrow: 1,
    marginVertical: '5%',
    marginHorizontal: !isTablet ? '5%' : '11%',
    // backgroundColor: colors.black,
  },
  sliderContainer: {
    width: '100%',

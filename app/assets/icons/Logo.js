...
const Logo = props => {
  return (
    <Svg
      ...
      />
      <Rect fill="#e4e4ec" x="176.4" y="62.1" width="59" height="219.4" />
      <Path fill="#e4e4ec" d="M457.2,281.4h0Z" transform="translate(0 0.1)" />
      <Path
        fill="#e4e4ec"
        d="M289.9,61.3V62h0v-.7Z"
        transform="translate(0 0.1)"
      />
      <Path fill="#e4e4ec" d="M354.5,62h0Z" transform="translate(0 0.1)" />
      <Path
        fill="#e4e4ec"
